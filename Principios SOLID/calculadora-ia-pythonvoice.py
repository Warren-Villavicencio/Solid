...
# Cargar el modelo de spaCy (asegúrate de haberlo descargado primero con: python -m spacy download es_core_news_sm)
...
class CalculadoraIAGUI:
    def __init__(self, master):
        ...
        master.title("Calculadora IA Avanzada")
    ...
    def configurar_voz(self):
        ...
        # Intenta configurar una voz en español si está disponible
